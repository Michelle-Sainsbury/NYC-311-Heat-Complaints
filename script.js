...
async function loadComplaintData() {
  ...
  try {
    ...
    const chartData = boroughOrder.map((borough) => ({
      borough,
    ...
    insightText.textContent =
      ...
      `of heat and hot water complaints among all five NYC boroughs during ` +
      `the selected time period, with ${formatNumber(highestBorough.count)} complaints.`;
